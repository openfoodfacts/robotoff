...
from robotoff.app.core import get_insights, get_random_insight, save_insight
...
from robotoff.taxonomy import TAXONOMY_STORES, Taxonomy, TaxonomyType
...
class AnnotateInsightResource:
    def on_post(self, req, resp):
        ...
        annotation = req.get_param_as_int("annotation", required=True, min=-1, max=1)
...
class RandomQuestionsResource:
    def on_get(self, req, resp):
        ...
        insights = list(
            get_insights(
                keep_types=keep_types, count=count, country=country, brands=brands
            )
        )
