...
from robotoff.prediction.ocr.origin import OriginParser, origin_parser
...
@pytest.mark.parametrize(
    ...
    [
        # French ----------
        (
            "quinoa fait en France",
            [
                {
                    "origin": "en:france",
                    "same_for_all_ingredients": False,
                    "concerned_ingredients": ["en:quinoa"],
                }
            ],
        ),
        (
        ...
        (
            "Notre quinoa est produit en France",
            [
                {
                    "origin": "en:france",
                    "same_for_all_ingredients": False,
        ...
        (
            ...
            [
                {
                    "origin": OriginParser.LARGE_ORIGIN,
                    "same_for_all_ingredients": False,
                    "concerned_ingredients": ["en:quinoa"],
                }
            ],
        ...
        (
            "Quinoa et riz français",
            [
                {
                    "origin": "en:france",
                    "same_for_all_ingredients": False,
                    "concerned_ingredients": ["en:quinoa", "en:rice"],
                }
            ],
        ),
        (
            ...
            [
                ...
                },
                {
                    "origin": "en:germany",
                    "same_for_all_ingredients": False,
                    "concerned_ingredients": ["en:wheat"],
                },
            ],
        ),
        (
        ...
        (
            "Our quinoa is produced in France",
            [
                {
                    "origin": "en:france",
                    "same_for_all_ingredients": False,
        ...
        (
            "quinoa farmed outside the European Union",
            [
                {
                    "origin": OriginParser.LARGE_ORIGIN,
                    "same_for_all_ingredients": False,
        ...
        (
            "Every ingredients are made in France",
            [
                {
                    "origin": "en:france",
                    "same_for_all_ingredients": True,
        ...
        (
            "The quinoa has several origins",
            [
                {
                    "origin": OriginParser.LARGE_ORIGIN,
                    "same_for_all_ingredients": True,
...
def test_find_origin(text: str, origins: List[Dict[str, Union[str, List[str], bool]]]):
    results = origin_parser.find_origin(text)
