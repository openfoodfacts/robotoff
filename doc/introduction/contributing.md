...
3.  The pull request should work for Python 3.7 and above. Check <https://travis-ci.org/github/openfoodfacts/robotoff/pull_requests> and make sure that the tests pass for all supported Python versions.
